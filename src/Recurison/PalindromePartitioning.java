...
public class PalindromePartitioning {
	...
	public static void main(String[] args) {
		String s = "aab";
		List<List<String>> pp = partition(s);
	...
	public static List<List<String>> partition(String s) {
		List<List<String>> validDecompositions = new ArrayList<List<String>>();
	 ...
	 */
	public static void decomposeString(String s, int buildPointer, List<String> decompInProgress,
